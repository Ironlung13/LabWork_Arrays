...
namespace LabWork_Arrays.Classes
{
    ...
    {
        public static void Task1Variant6(string inputFilePath = @"D:\Text Files\EPAM_Arrays\Matrices\input.io")
        {
            int[,] array;
        ...
        private static int[,] Task1Variant6ManualInput(string inputFilePath = @"D:\Text Files\EPAM_Arrays\Matrices\input.io")
        {
        ...
        private static int[,] GetMatrixAndWriteToFile(int size, string outputFilePath = @"D:\Text Files\EPAM_Arrays\Matrices\output.io")
        {
